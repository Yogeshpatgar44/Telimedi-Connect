				...
				<div className="row">
					<div className="col-12 col-md-3 col-lg-3">
						<div className='mb-2 section-title text-center'>
							...
							<p className='m-0 text-secondary'>Your health is our priority—schedule a consultation today.</p>
						</div>
						<div className="form-text">
							<p>Finding the right doctor at the right time is essential for your well-being. Our expert medical team is here to provide personalized care tailored to your needs.</p>
							<p>With a simple booking process and trusted professionals, we ensure a smooth experience from appointment to recovery. Explore our specialists and book your visit today.</p>
