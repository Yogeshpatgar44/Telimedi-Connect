                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-4">
                        <div className="service-content ps-4 mt-4 mt-lg-0">
                            ...
                            <p className="mt-4 mb-5 text-secondary form-text">We provide top-quality medical services with a commitment to excellence and patient care you can trust.</p>
